...
MANIM_CODE_PROVIDER = os.getenv("MANIM_CODE_PROVIDER", "9router")
MANIM_9ROUTER_MODEL = os.getenv("MANIM_9ROUTER_MODEL", "cx/gpt-5.5-xhigh")
MANIM_9ROUTER_BASE_URL = os.getenv("MANIM_9ROUTER_BASE_URL", "")
MANIM_9ROUTER_API_KEY = os.getenv("MANIM_9ROUTER_API_KEY", "")
